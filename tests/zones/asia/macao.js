...
exports["Asia/Macao"] = {
	...
	"guess:by:offset": helpers.makeTestGuess("Asia/Macao", { offset: true, expect: "Asia/Manila" }),

	"guess:by:abbr": helpers.makeTestGuess("Asia/Macao", { abbr: true, expect: "Asia/Shanghai" }),

	"1941": helpers.makeTestYear("Asia/Macao", [
		["1941-12-21T14:59:59+00:00", "22:59:59", "CST", -480],
		["1941-12-21T15:00:00+00:00", "00:00:00", "+09", -540]
	]),

	"1942": helpers.makeTestYear("Asia/Macao", [
	...
	"1943": helpers.makeTestYear("Asia/Macao", [
	...
	"1947": helpers.makeTestYear("Asia/Macao", [
	...
	"1948": helpers.makeTestYear("Asia/Macao", [
	...
	"1949": helpers.makeTestYear("Asia/Macao", [
	...
	"1950": helpers.makeTestYear("Asia/Macao", [
	...
	"1951": helpers.makeTestYear("Asia/Macao", [
	...
	"1952": helpers.makeTestYear("Asia/Macao", [
	...
	"1953": helpers.makeTestYear("Asia/Macao", [
	...
	"1954": helpers.makeTestYear("Asia/Macao", [
	...
	"1955": helpers.makeTestYear("Asia/Macao", [
	...
	"1956": helpers.makeTestYear("Asia/Macao", [
	...
	"1957": helpers.makeTestYear("Asia/Macao", [
	...
	"1958": helpers.makeTestYear("Asia/Macao", [
	...
	"1959": helpers.makeTestYear("Asia/Macao", [
	...
	"1960": helpers.makeTestYear("Asia/Macao", [
	...
	"1961": helpers.makeTestYear("Asia/Macao", [
	...
	"1962": helpers.makeTestYear("Asia/Macao", [
	...
	"1963": helpers.makeTestYear("Asia/Macao", [
	...
	"1964": helpers.makeTestYear("Asia/Macao", [
	...
	"1965": helpers.makeTestYear("Asia/Macao", [
	...
	"1966": helpers.makeTestYear("Asia/Macao", [
	...
	"1967": helpers.makeTestYear("Asia/Macao", [
	...
	"1968": helpers.makeTestYear("Asia/Macao", [
	...
	"1969": helpers.makeTestYear("Asia/Macao", [
	...
	"1970": helpers.makeTestYear("Asia/Macao", [
	...
	"1971": helpers.makeTestYear("Asia/Macao", [
	...
	"1972": helpers.makeTestYear("Asia/Macao", [
	...
	"1973": helpers.makeTestYear("Asia/Macao", [
	...
	"1976": helpers.makeTestYear("Asia/Macao", [
	...
	"1979": helpers.makeTestYear("Asia/Macao", [
