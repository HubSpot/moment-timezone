...
exports["PRC"] = {
	...
	"guess:by:offset": helpers.makeTestGuess("PRC", { offset: true, expect: "Asia/Manila" }),

	"guess:by:abbr": helpers.makeTestGuess("PRC", { abbr: true, expect: "Asia/Shanghai" }),
